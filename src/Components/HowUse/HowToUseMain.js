...
const HowToUseMain = () => {
  ...
  <div className="row">
    <article className="col-sm pt-4">
      ...
      <p className="pt-2">All being well, we will transfer the money to the landlord 48 hours after you move in</p>
    </article>
    <article className="col-sm pt-4">
      <PieIcon/>
      <h6 className="pt-4">Last minute cancellation</h6>
      <p className="pt-2">If the landlord cancels at the last minute, we will relocate you and help with your hotel costs if needed</p>
    </article>
    <article className="col-sm pt-4">
      <EyeIcon/>
      <h6 className="pt-4">Checked by StudentSpaceRents</h6>
      <p className="pt-2">We show you real photos and video of each property. We let you see inside drawers and cupboards and show you every corner of the property.</p>
    </article>
  </div>
</div>
    </section>
